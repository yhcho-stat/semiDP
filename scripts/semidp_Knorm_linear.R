# Comparing K-norm mechanisms on Contingency table with the cell probabilities increase linearly
#rm(list=ls())
...
runsimul <- function(eps, k, SensL1, SensL2, SensLinf, SensK, SemiAdj, n, seed){
  ...
  p <- generate_linear_vector(k) # For k x k table, we need k^2 probabilities
